...
function Footer() {
    return (
        ...
        <section id="section6" className="no-padding">
                    ...
                    <div className="map" data-latitude="-37.817240" data-longitude="144.955826" data-style="light"
        ...
        <footer id="footer">
                    ...
                    <div className="row">
                        <div className="col-lg-5">
                            <div className="widget">
                                ...
                                <p className="mb-5">Built with love in Fort Worth, Texas, USA<br /> All rights reserved.
            ...
            <div className="copyright-content">
                <div className="container">
                    <div className="copyright-text text-center">&copy; 2021 POLO - Responsive Multi-Purpose HTML5 Template.
